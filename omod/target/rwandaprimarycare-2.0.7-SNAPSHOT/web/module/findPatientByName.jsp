...
<c:if test="${results == null}">
	<form method="get">
		...
		<tr>
			...
			<td><touchscreen:textInput  required="true"  label="${rwandanName}" field_name="RWNAME" fieldType="upper" value="${search}" allowFreeText="true" ajaxURL="findPatientByNameAjax.form?searchType=RWNAME&search="/></td>
		</tr>
		<tr>
...
<tr>
			...
			<td><touchscreen:textInput  required="false" label="${CountryStr}" field_name="COUNTRY" value="Rwanda" allowFreeText="false" ajaxURL="findPatientByNameAjax.form?searchType=COUNTRY&search="  javascriptAction="updateAddressHierarchyCache()"/></td>
		</tr>
		<tr>
